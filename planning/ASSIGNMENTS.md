...
| vaco-codec-vp9 + vaco-codec-msac (epics #28, #32) | 3 | VP8 + VP9 decode; #329 encode; #330 (RDO/mode decision) | agent:vp8vp9-enc | assigned | 2026-08-28 | — | No crate is named `vaco-codec-vpx` — the real crates are `vaco-codec-vp9` and `vaco-codec-msac`. Decode and #329 (all-intra key-frame encode) done. Claiming #330 (C-33b, partition search + intra mode decision, next increment past the flat-128 stand-in) as part of a VP8/VP9 encode batch — see the vaco-codec-vp8/vaco-codec-webp row below for the rest of that batch. #331-#334 remain free. |
...
| vaco-codec-vp8 + vaco-codec-webp | 4 | #303 #304 #305 #307 | agent:vp8vp9-enc | assigned | 2026-08-28 | — | VP8 encode: real mode decision/RDO (#303), motion estimation over vaco-codec-dsp-me (#304), rate control over vaco-codec-dsp-ratecontrol (#305); WebP native lossless + route lossy through VP8 (#307). Paired with the vaco-codec-vp9 row above (#330) as one dispatch, same DSP dependencies. |
