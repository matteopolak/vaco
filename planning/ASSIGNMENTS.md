...
| vaco-codec-vp9 + vaco-codec-msac (epics #28, #32) | 3 | VP8 + VP9 decode; #329 encode | agent:vp8vp9-enc | done | 2026-08-28 | 2026-08-28 | No crate is named `vaco-codec-vpx` — the real crates are `vaco-codec-vp9` and `vaco-codec-msac`. Decode and #329 (all-intra key-frame encode) done, unchanged this round. RELEASED 2026-08-28: #330 (partition search/mode decision) was claimed but not attempted — time went to the vaco-codec-vp8 batch below per the dispatch's own priority order. VP9 is a structurally different codec from VP8 (superblock partitioning, four transform sizes, adaptive-CDF entropy), not a small extension of that work. #330-#334 remain free for a future dispatch. |
...
| vaco-codec-dv | 4 | #372 | agent:t2-video | active | 2026-08-28 | — | Reclaimed from the free row left by agent:t2-batch. Builds on the already-landed vaco-format-dv framing layer per that row's pointer. |
| vaco-codec-prores (new) | 4 | #41 (T2-09) | agent:t2-video | active | 2026-08-28 | — | decode-only per the legal register (5.1: 'ProRes decode -- decode only, never encode'); vaco-codec-dnxhd (the sibling crate #41 also names) not attempted this pass. |
| vaco-codec-vc1 (new) | 4 | #42 (T2-10) | agent:t2-video | active | 2026-08-28 | — | VC-1/WMV3 is absent from planning/research/07-legal-patents-licensing.md entirely (no row); treated conservatively like H.264 -- encumbered=true, default=false -- pending an owner ruling, not GREEN by default per D4. |
