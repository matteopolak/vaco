...
| vaco-codec-vp8 | 4 | #303 #304 #305 | agent:vp8vp9-enc | done | 2026-08-28 | 2026-08-28 | VP8 encode: real mode decision/RDO (#303), motion estimation over vaco-codec-dsp-me (#304), rate control over vaco-codec-dsp-ratecontrol (#305) — all three closed, commit 18a7a42. Verified via this crate's own decoder AND two external decoders (ffmpeg native + ffmpeg -c:v libvpx); measured PSNR/SSIM (ffmpeg psnr/ssim filters) Y/U/V 34.7/28.7/29.0 dB, SSIM 0.999/0.993/0.993 on an 8-frame sequence. Found and fixed a real chroma-coordinate bug this crate's own decoder round-trip and a luma-only quality check both missed — only measuring chroma PSNR against ffmpeg-decoded output caught it (see #303's issue comment). Scope cuts, all documented in encode.rs's module doc: no B_PRED/SPLITMV, single LAST reference only, no segmentation/lf-deltas, no cross-frame entropy adaptation, no re-keying past frame 0. RELEASED 2026-08-28: vaco-codec-webp / #307 was claimed but not attempted (dropped per the dispatch's own priority order) — free for a future dispatch. |
