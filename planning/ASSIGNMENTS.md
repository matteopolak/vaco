...
| vaco-codec-dsp-mecmp | 3 | #144 (D-12) | agent:me-rc | assigned | 2026-08-28 | — | motion-estimation comparison functions: SAD/SSD/variance (vectorised) + SATD (scalar, Hadamard-tiled); blocks #304/#305 (VP8 encode) via D-13/D-14 |
| vaco-codec-dsp-me | 3 | #260 (D-13) | agent:me-rc | assigned | 2026-08-28 | — | motion-estimation search patterns (full/diamond/three-step), built on vaco-codec-dsp-mecmp; do not split from it, D-13 calls D-12 directly |
| vaco-codec-dsp-ratecontrol | 3 | #146 (D-14) | agent:me-rc | assigned | 2026-08-28 | — | policy, not bit-exact per owner ruling 2026-08-28; judged on measured convergence to target bitrate, not a specific curve |
