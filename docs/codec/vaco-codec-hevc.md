...
prefix bin is measured as 1, selecting MPM index 2. Its mode resolution and all
later mode-dependent syntax remain unconsumed. Finally it sends the same access
