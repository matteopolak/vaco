...
//!
//! This crate's option parsers include several things worth fuzzing beyond
...
//! `square`/`row`/`column` mode), `boxblur`'s plain-integer radius parser,
//! and `median`/`avgblur`'s zero-as-sentinel radius handling.
//!
