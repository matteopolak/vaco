//! Arbitrary filtergraph option text against every filter `vaco-filter-motion`
//! registers (`framerate`, `deshake`) — same shape as `filter_mm_options.rs`.
//!
...
//! fuzz-crate: vaco-filter-motion

#![no_main]

use libfuzzer_sys::fuzz_target;
use vaco_filter_graph::registry::{FilterRegistry, Instantiate};
use vaco_filter_motion::MotionRegistry;
