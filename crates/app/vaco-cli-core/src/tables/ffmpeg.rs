...
static FFMPEG_OPTIONS: &[OptDesc] = &[
    ...
    alias("?", Some("topic"), bit::EXIT | bit::GLOBAL | bit::EXPERT, ValueKind::None, "print help on a topic", "h", ""),
    alias("help", Some("topic"), bit::EXIT | bit::GLOBAL | bit::EXPERT, ValueKind::None, "print help on a topic", "h", ""),
    alias("-help", Some("topic"), bit::EXIT | bit::GLOBAL | bit::EXPERT, ValueKind::None, "print help on a topic", "h", ""),
    ...
    o("sources", Some("device"), bit::EXIT | bit::GLOBAL | bit::EXPERT, ValueKind::None, "list a device's input sources"),
    o("sinks", Some("device"), bit::EXIT | bit::GLOBAL | bit::EXPERT, ValueKind::None, "list a device's output sinks"),
