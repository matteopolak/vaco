...
mod tests {
    ...
    fn amvp_falls_back_to_zero_when_nothing_is_available() {
        let grid = CuGrid::new(&mut vaco_limits::Budget::new(vaco_limits::Limits::strict()), 64, 64, true).unwrap();
    ...
    fn amvp_finds_a_match_in_the_other_list_by_poc() {
        ...
        let mut grid = CuGrid::new(&mut vaco_limits::Budget::new(vaco_limits::Limits::strict()), 64, 64, true).unwrap();
