...
//! size, `CONSTANT`/`VERBATIM`/fixed-predictor subframes and single-
...
//! reference source. See [`encoder`]'s module doc for exactly what that
//! encoder does and does not implement (no LPC, no stereo decorrelation, no
//! multi-partition residuals — none of which affect correctness).
//!
