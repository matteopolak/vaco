...
//! (coupling) is refused; `channelConfiguration` 11/12/14 are
...
/// config element (`known_channel_count` in `crate::config`: 1 through 7).
///
...
/// element structure does not have a verified map, and the 11/12/14 values
