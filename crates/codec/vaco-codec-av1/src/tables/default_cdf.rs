...
//! `scripts/extract_cdf.py` rather than retyped by hand: the script
//! brace-matches each `Default_X_Cdf[dims] = { ... }`
...
#![allow(
    ...
    reason = "adapted per-tile via a Clone, so these stay `const` rather than `static`; the largest \
              (coeff_base/coeff_br) are still only tens of kilobytes"
)]

/// `Default_Intra_Frame_Y_Mode_Cdf`, spec 9.4.
pub const DEFAULT_INTRA_FRAME_Y_MODE_CDF: [[[u16; 14]; 5]; 5] = [
    [
        [
...
/// `Default_Uv_Mode_Cfl_Not_Allowed_Cdf`, spec 9.4.
pub const DEFAULT_UV_MODE_CFL_NOT_ALLOWED_CDF: [[u16; 14]; 13] = [
    [
...
/// `Default_Uv_Mode_Cfl_Allowed_Cdf`, spec 9.4.
pub const DEFAULT_UV_MODE_CFL_ALLOWED_CDF: [[u16; 15]; 13] = [
    [
...
/// `Default_Angle_Delta_Cdf`, spec 9.4.
pub const DEFAULT_ANGLE_DELTA_CDF: [[u16; 8]; 8] = [
...
/// `Default_Intrabc_Cdf`, spec 9.4.
pub const DEFAULT_INTRABC_CDF: [u16; 3] = [30531, 32768, 0];

/// `Default_Partition_W8_Cdf`, spec 9.4.
pub const DEFAULT_PARTITION_W8_CDF: [[u16; 5]; 4] = [
...
/// `Default_Partition_W16_Cdf`, spec 9.4.
pub const DEFAULT_PARTITION_W16_CDF: [[u16; 11]; 4] = [
    [
...
/// `Default_Partition_W32_Cdf`, spec 9.4.
pub const DEFAULT_PARTITION_W32_CDF: [[u16; 11]; 4] = [
    [
...
/// `Default_Partition_W64_Cdf`, spec 9.4.
pub const DEFAULT_PARTITION_W64_CDF: [[u16; 11]; 4] = [
    [
...
/// `Default_Partition_W128_Cdf`, spec 9.4.
pub const DEFAULT_PARTITION_W128_CDF: [[u16; 9]; 4] = [
...
/// `Default_Tx_8x8_Cdf`, spec 9.4.
pub const DEFAULT_TX_8X8_CDF: [[u16; 3]; 3] =
    [[19968, 32768, 0], [19968, 32768, 0], [24320, 32768, 0]];

/// `Default_Tx_16x16_Cdf`, spec 9.4.
pub const DEFAULT_TX_16X16_CDF: [[u16; 4]; 3] = [
    [12272, 30172, 32768, 0],
    [12272, 30172, 32768, 0],
    [18677, 30848, 32768, 0],
];

/// `Default_Tx_32x32_Cdf`, spec 9.4.
pub const DEFAULT_TX_32X32_CDF: [[u16; 4]; 3] = [
    [12986, 15180, 32768, 0],
    [12986, 15180, 32768, 0],
    [24302, 25602, 32768, 0],
];

/// `Default_Tx_64x64_Cdf`, spec 9.4.
pub const DEFAULT_TX_64X64_CDF: [[u16; 4]; 3] = [
    [5782, 11475, 32768, 0],
    [5782, 11475, 32768, 0],
    [16803, 22759, 32768, 0],
];

/// `Default_Segment_Id_Cdf`, spec 9.4.
pub const DEFAULT_SEGMENT_ID_CDF: [[u16; 9]; 3] = [
...
/// `Default_Skip_Cdf`, spec 9.4.
pub const DEFAULT_SKIP_CDF: [[u16; 3]; 3] =
    [[31671, 32768, 0], [16515, 32768, 0], [4576, 32768, 0]];

/// `Default_Delta_Q_Cdf`, spec 9.4.
pub const DEFAULT_DELTA_Q_CDF: [u16; 5] = [28160, 32120, 32677, 32768, 0];

/// `Default_Delta_Lf_Cdf`, spec 9.4.
pub const DEFAULT_DELTA_LF_CDF: [u16; 5] = [28160, 32120, 32677, 32768, 0];

/// `Default_Intra_Tx_Type_Set1_Cdf`, spec 9.4.
pub const DEFAULT_INTRA_TX_TYPE_SET1_CDF: [[[u16; 8]; 13]; 2] = [
    [
...
/// `Default_Intra_Tx_Type_Set2_Cdf`, spec 9.4.
pub const DEFAULT_INTRA_TX_TYPE_SET2_CDF: [[[u16; 6]; 13]; 3] = [
    [
...
/// `Default_Txb_Skip_Cdf`, spec 9.4.
pub const DEFAULT_TXB_SKIP_CDF: [[[[u16; 3]; 13]; 5]; 4] = [
    [
        [
            [31849, 32768, 0],
            [5892, 32768, 0],
...
/// `Default_Eob_Pt_16_Cdf`, spec 9.4.
...
/// `Default_Eob_Pt_32_Cdf`, spec 9.4.
...
/// `Default_Eob_Pt_64_Cdf`, spec 9.4.
...
/// `Default_Eob_Pt_128_Cdf`, spec 9.4.
...
/// `Default_Eob_Pt_256_Cdf`, spec 9.4.
...
/// `Default_Eob_Pt_512_Cdf`, spec 9.4.
pub const DEFAULT_EOB_PT_512_CDF: [[[u16; 11]; 2]; 4] = [
    [
        [
...
/// `Default_Eob_Pt_1024_Cdf`, spec 9.4.
pub const DEFAULT_EOB_PT_1024_CDF: [[[u16; 12]; 2]; 4] = [
    [
        [
...
/// `Default_Eob_Extra_Cdf`, spec 9.4.
...
/// `Default_Dc_Sign_Cdf`, spec 9.4.
pub const DEFAULT_DC_SIGN_CDF: [[[[u16; 3]; 3]; 2]; 4] = [
    [
        [
            [128 * 125, 32768, 0],
            [128 * 102, 32768, 0],
...
/// `Default_Coeff_Base_Eob_Cdf`, spec 9.4.
...
/// `Default_Coeff_Base_Cdf`, spec 9.4.
...
/// `Default_Palette_Y_Mode_Cdf`, spec 9.4. `PALETTE_BLOCK_SIZE_CONTEXTS = 7`,
...
/// `Default_Palette_Uv_Mode_Cdf`, spec 9.4. `PALETTE_UV_MODE_CONTEXTS = 2`.
