...
pub static COMPONENTS: &[crate::Component] = &[
    ...
    #[cfg(feature = "demux-brstm")]
    crate::Component {
        kind: crate::Kind::Demuxer,
        name: "brstm",
        long_name: Some("Nintendo BRSTM (stereo DSP-ADPCM)"),
        krate: "vaco-format-misc-audio",
        feature: Some("demux-brstm"),
        media: None,
        codec: None,
        extensions: &["brstm"],
        mime_types: &[],
    ...
    crate::Component {
        ...
        krate: "vaco-codec-subtitle-text",
        feature: Some("codec-subtitle-text"),
        media: Some("subtitle"),
        codec: Some("ass"),
        extensions: &[],
        mime_types: &[],
    ...
    #[cfg(feature = "codec-subtitle-cc")]
    crate::Component {
        kind: crate::Kind::Decoder,
        name: "cc_dec",
        long_name: Some("Closed Captions (EIA-608 / CEA-708)"),
        krate: "vaco-codec-subtitle-cc",
        feature: Some("codec-subtitle-cc"),
        media: Some("subtitle"),
        codec: Some("eia_608"),
        extensions: &[],
        mime_types: &[],
    ...
    crate::Component {
        kind: crate::Kind::Decoder,
        name: "mov_text",
        long_name: Some("3GPP Timed Text subtitle"),
        krate: "vaco-codec-subtitle-text",
        feature: Some("codec-subtitle-text"),
        media: Some("subtitle"),
        codec: Some("mov_text"),
    ...
    crate::Component {
        kind: crate::Kind::Decoder,
        name: "text",
        long_name: Some("Raw text subtitle"),
        krate: "vaco-codec-subtitle-text",
        feature: Some("codec-subtitle-text"),
        media: Some("subtitle"),
        codec: Some("text"),
    ...
    crate::Component {
        kind: crate::Kind::Filter,
        name: "ciescope",
        long_name: Some("Video CIE scope."),
        krate: "vaco-filter-scope",
        feature: None,
        media: Some("video"),
        codec: None,
    ...
    crate::Component {
        kind: crate::Kind::Filter,
        name: "normalize",
        long_name: Some("Normalize RGB video"),
        krate: "vaco-filter-color",
        feature: None,
        media: Some("video"),
        codec: None,
    ...
    crate::Component {
        kind: crate::Kind::Filter,
        name: "oscilloscope",
        long_name: Some("2D Video Oscilloscope."),
        krate: "vaco-filter-scope",
        feature: None,
        media: Some("video"),
        codec: None,
    ...
    crate::Component {
        kind: crate::Kind::Filter,
        name: "siti",
        long_name: Some("Calculate spatial information and temporal information."),
        krate: "vaco-filter-analysis",
        feature: None,
        media: Some("video"),
        codec: None,
    ...
    crate::Component {
        kind: crate::Kind::Filter,
        name: "tonemap",
        long_name: Some("Convert HDR video to BT.709 SDR with BT.2390"),
        krate: "vaco-filter-color",
        feature: None,
        media: Some("video"),
        codec: None,
    ...
    crate::Component {
        kind: crate::Kind::Filter,
        name: "vmafmotion",
        long_name: Some("Calculate the VMAF Motion score."),
        krate: "vaco-filter-analysis",
        feature: None,
        media: Some("video"),
        codec: None,
    ...
    crate::Component {
        kind: crate::Kind::FilterDispatch,
        name: "vaco-filter-aanalysis",
        long_name: None,
        krate: "vaco-filter-aanalysis",
        feature: None,
        media: None,
    ...
    crate::Component {
        kind: crate::Kind::FilterDispatch,
        name: "vaco-filter-video-composite",
        long_name: None,
        krate: "vaco-filter-video-composite",
        feature: None,
        media: None,
    ...
    crate::Component {
        kind: crate::Kind::FilterDispatch,
        name: "vaco-filter-video-geometry",
        long_name: None,
        krate: "vaco-filter-video-geometry",
        feature: None,
        media: None,
...
pub static DEMUXERS: &[&::vaco_format_core::DemuxerDesc] = &[
    ...
    #[cfg(feature = "demux-brstm")]
    &::vaco_format_misc_audio::brstm::DEMUXER,
    #[cfg(feature = "demux-caf")]
...
pub static DECODERS: &[&::vaco_codec_core::DecoderDesc] = &[
    ...
    #[cfg(feature = "codec-subtitle-text")]
    &::vaco_codec_subtitle_text::registry::ASS_DECODER,
    #[cfg(feature = "codec-rawvideo")]
    ...
    #[cfg(feature = "codec-subtitle-text")]
    &::vaco_codec_subtitle_text::registry::MOVTEXT_DECODER,
    #[cfg(feature = "codec-mpegaudio")]
    ...
    #[cfg(feature = "codec-subtitle-text")]
    &::vaco_codec_subtitle_text::registry::SSA_DECODER,
    #[cfg(feature = "codec-subtitle-text")]
    ...
    #[cfg(feature = "codec-subtitle-text")]
    &::vaco_codec_subtitle_text::registry::TTML_DECODER,
    #[cfg(feature = "codec-rawvideo")]
    ...
    #[cfg(feature = "codec-subtitle-text")]
    &::vaco_codec_subtitle_text::registry::WEBVTT_DECODER,
    #[cfg(feature = "codec-rawvideo")]
...
pub static FILTERS: &[&::vaco_filter_core::FilterDesc] = &[
    ...
    &::vaco_filter_scope::ciescope::DESC,
    ...
    &::vaco_filter_analysis::siti::DESC,
    ...
    &::vaco_filter_color::tonemap::DESC,
    ...
    &::vaco_filter_analysis::vmafmotion::DESC,
