...
fn main() {
    ...
    match task.as_str() {
        ...
        "patent-check" => todo!("P0-04: assert patent-encumbered features absent from default (D4)"),
        ...
        other => {
            ...
            eprintln!("tasks: layer-check dep-gate unsafe-audit patent-check gen-registry gen-docs-index");
            std::process::exit(2);
        }
    }
}
